...
public abstract class ConsoleApplication {
     ...
     * textt console (currently stdin and stdout).</li>
     ...
     * application, prompting the user for textt input and displaying
     * textt output. It is named differently than
     ...
     * @param consoleOut the destination where textt output should be printed
     */
